...
#define TVX         83     // 112x56 = 6272 bytes 104x56 = 5824
#define TVY         47      // 136x96 = 13056 bytes
...
#define ZSTEP       32  // length of rumble segments, was 32
#define DXDIV       32  // Number of steps from centerline to roadside
#define NUMSPOTS    10  // Number of roadside spots flying by
...
#define ROADW       1400    // Road width in worldspace, was 1600
...
#define RUMBLEW     3      // Rumble width, higher number = thinner, was 12
...
extern const uint8_t colorlookup[] PROGMEM;
extern const uint8_t track1[] PROGMEM;
...
class Game : public Rboy {
public:
	void update();
    void drawSky(int,int);
    void drawRoad();
    void updatecar();
    void updateHUD();
    void gameSetup();
